...
public class FishingQuizManager : MonoBehaviour
{
    ...
    {
        Debug.Log("<color=green>[FishingQuizManager Debug] Q Key Pressed - Instant Win!</color>");
        ShowWinScreen();
    }

    public void DebugLoseGame()
    {
        Debug.Log("<color=red>[FishingQuizManager Debug] E Key Pressed - Instant Lose!</color>");
        ShowLoseScreen();
    }
    ...
    private void ExitMinigameToPreviousScene()
    {
